...
def subdomain_hunt():
    ...
    common_subs = [
        "www", "mail", "ftp", "admin", "api", "blog", "cdn", "dev", "test", "staging",
        "portal", "webmail", "cpanel", "webdisk", "ns1", "ns2", "mx", "pop", "imap",
        "smtp", "secure", "vpn", "mobile", "m", "shop", "store", "support", "help",
        "docs", "status", "monitor", "dashboard", "app", "apps", "beta", "alpha",
        "demo", "staging", "prod", "production", "backup"
    ]
...
def dev_info():
    ...
    console.print(Panel.fit(
        ...
        "[yellow]This tool is powered by Mr raj (don't copy tool).[/yellow]\n"
